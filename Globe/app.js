...
var distance = Math.min(200, window.innerWidth / 8);
...
var particles = new THREE.Points(geometry, new THREE.PointsMaterial({ color: 0x00FF00, size: 2 }));
